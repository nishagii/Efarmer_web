...
import './styleall.css';
import oldfruits from '../../Components/Assets/oldfruits';

function Oldfruits() {
    // Initialize totalAmount based on initial products
    const [products, setProducts] = useState(oldfruits);
    const [totalAmount, setTotalAmount] = useState(
        oldfruits.reduce((sum, product) => sum + product.price * product.quantity, 0)
    );
        ...
        <div className="home-page">
            ...
            <section className="conditions">
                ...
                <ul>
                    ...
                    <li>No fresh fruits, these are unusable or close to spoil.</li>
